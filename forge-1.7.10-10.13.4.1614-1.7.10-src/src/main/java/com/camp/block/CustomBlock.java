...
public class CustomBlock extends Block{
	private String blockName = "Ugly_Block";
	private String blockTexture = "Ugly_Block";
	...
	public CustomBlock addItemDropped(Item diamondBlock){
		this.drop = diamondBlock;
		return this;
	}
	@Override
	...
	public Item getBlockDropped(int meta, Random random, int fortune) {
	    return this.drop;
	}
}